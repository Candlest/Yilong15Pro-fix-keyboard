...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x0107200A)
{
    ...
    External (_SB_.PC00.LPCB.EC0_.GFID, IntObj)
    ...
    External (_SB_.PCI0.GPP0.PG00._OFF, MethodObj)    // 0 Arguments
    ...
    External (_SB_.SBRG.SBRG.EC0_.CMD2, IntObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x9713FD98, 0x0D)
    ...
    {
        Name (UWSV, 0x02)
        OperationRegion (UWNV, SystemMemory, 0x97140018, 0x00070000)
    }
    ...
    Scope (_SB.PCI0.SBRG)
    {
        Device (EC0)
        {
            ...
            Method (QKUD, 0, NotSerialized)
            {
                If ((((((MOID == One) || (MOID == 0x03)) || (
                    MOID == 0x08)) || (MOID == 0x09)) || (MOID == 0x0D)))
                {
                    If (CUME)
                    {
                        M010 (0x05, One)
    ...
    Name (WTBQ, Buffer (0x2A)
    {
        /* 0000 */  0x11, 0x04, 0x13, 0x02, 0x00, 0xFF, 0x00, 0x2F,  // ......./
        /* 0008 */  0x30, 0x34, 0x35, 0x38, 0x39, 0x3C, 0x3D, 0x40,  // 04589<=@
        /* 0010 */  0x41, 0x44, 0x45, 0x48, 0x49, 0x4E, 0x4F, 0x05,  // ADEHINO.
        /* 0018 */  0xFF, 0x00, 0x2F, 0x30, 0x34, 0x35, 0x37, 0x38,  // ../04578
        /* 0020 */  0x3A, 0x3B, 0x3D, 0x3E, 0x40, 0x41, 0x43, 0x44,  // :;=>@ACD
        /* 0028 */  0x48, 0x49                                       // HI
    })
    Name (WSLX, Buffer (0x5F)
    {
        /* 0000 */  0x11, 0x04, 0x5B, 0x01, 0x05, 0x00, 0x01, 0x02,  // ..[.....
        /* 0008 */  0x03, 0x04, 0x03, 0x01, 0x02, 0x03, 0x00, 0x01,  // ........
        /* 0010 */  0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04, 0x01,  // ........
    ...
    Name (WDAD, Buffer (0x59)
    {
        /* 0000 */  0x10, 0x04, 0x11, 0x05, 0x64, 0x70, 0x17, 0x00,  // ....dp..
        /* 0008 */  0x00, 0x88, 0x13, 0x00, 0x00, 0x98, 0x3A, 0x00,  // ......:.
        /* 0010 */  0x00, 0xA8, 0x61, 0x00, 0x00, 0x4F, 0x70, 0x17,  // ..a..Op.
        /* 0018 */  0x00, 0x00, 0x88, 0x13, 0x00, 0x00, 0x98, 0x3A,  // .......:
        /* 0020 */  0x00, 0x00, 0xA8, 0x61, 0x00, 0x00, 0x3B, 0x70,  // ...a..;p
        /* 0028 */  0x17, 0x00, 0x00, 0x88, 0x13, 0x00, 0x00, 0x98,  // ........
        /* 0030 */  0x3A, 0x00, 0x00, 0xA8, 0x61, 0x00, 0x00, 0x27,  // :...a..'
        /* 0038 */  0x70, 0x17, 0x00, 0x00, 0x88, 0x13, 0x00, 0x00,  // p.......
        /* 0040 */  0x98, 0x3A, 0x00, 0x00, 0x98, 0x3A, 0x00, 0x00,  // .:...:..
        /* 0048 */  0x13, 0x70, 0x17, 0x00, 0x00, 0x88, 0x13, 0x00,  // .p......
        /* 0050 */  0x00, 0x98, 0x3A, 0x00, 0x00, 0x98, 0x3A, 0x00,  // ..:...:.
        /* 0058 */  0x00                                             // .
    })
    Scope (_SB)
    {
        Device (INOU)
        {
            ...
            {
                /* 0000 */  0x5A, 0x5A, 0x64, 0x64, 0x14, 0x19, 0x57, 0x5F,  // ZZdd..W_
                /* 0008 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
            })
            Name (AX40, Buffer (0x0C)
            {
                /* 0000 */  0x5A, 0x5A, 0x64, 0x64, 0x00, 0x19, 0x57, 0x73,  // ZZdd..Ws
                /* 0008 */  0xFF, 0xFF, 0xFF, 0xFF                           // ....
            })
    ...
    Scope (_SB.PCI0.GP17.XHC1)
    {
        Device (RHUB)
        {
            ...
            Device (KB0)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.KB0._UPC\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M600 (One, 0xFF))
                }

                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.KB0._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M601 (0x02, Zero, 0x0202, Zero, 0x0112, 0x00AF00E1))
                }
            }
            ...
            Device (KB1)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.KB1._UPC\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M600 (One, 0xFF))
                }

                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.KB1._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M601 (0x02, Zero, 0x0203, Zero, 0x0112, 0x00AF00E1))
                }
            }
            ...
            Device (FP0)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.FP0._UPC\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M600 (One, 0xFF))
                }

                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.FP0._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M601 (0x02, Zero, 0x0204, Zero, 0x0112, 0x00AF00E1))
                }
            }
            ...
            Device (SD0)
            {
                ...
                Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.SD0._UPC\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M600 (One, 0xFF))
                }

                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    M460 ("PLA-ASL-\\_SB.PCI0.GP17.XHC1.RHUB.PRT1.SD0._PLD\n", Zero, Zero, Zero, Zero, Zero, Zero)
                    Return (M601 (0x02, Zero, 0x0205, Zero, 0x0112, 0x00AF00E1))
                }
            }
        }
    }
        ...
        Device (RHUB)
        {
            ...
            Device (PRT2)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    ...
                    Else
                    {
                        Return (M601 (0x02, Zero, 0x0401, 0x03, 0x0112, Zero))
                    }
                }
            }
        }
